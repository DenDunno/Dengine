...
public class Transform
{
    ...
    public Transform(Transform transform) : this(Vector3.One, Quaternion.Identity, Vector3.Zero, transform)
    {
    }
    ...
    public Transform(Quaternion rotation) : this(Vector3.One, rotation, Vector3.Zero, null)
    {
    }
