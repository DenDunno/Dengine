...
public unsafe partial struct ImDrawDataPtr {
	...
	public ImGuiViewportPtr OwnerViewport => new(NativePtr->OwnerViewport);
	public void Clear() => ImGuiNative.ImDrawData_Clear((ImDrawData*)(NativePtr));
	public void DeIndexAllBuffers() => ImGuiNative.ImDrawData_DeIndexAllBuffers((ImDrawData*)(NativePtr));
	public void Destroy() => ImGuiNative.ImDrawData_destroy((ImDrawData*)(NativePtr));
	public void ScaleClipRects(Vector2 fb_scale) => ImGuiNative.ImDrawData_ScaleClipRects((ImDrawData*)(NativePtr), fb_scale);
}
