...
public unsafe partial struct ImGuiWindowPtr {
	...
	public ImGuiViewportPPtr Viewport => new(NativePtr->Viewport);
	...
	public ImVector<uint> IDStack => new(NativePtr->IDStack);
	...
	public ImPtrVector<ImGuiOldColumnsPtr> ColumnsStorage => new(NativePtr->ColumnsStorage, Unsafe.SizeOf<ImGuiOldColumns>());
	...
	public ImDrawListPtr DrawList => new(NativePtr->DrawList);
	public ref ImDrawList DrawListInst => ref Unsafe.AsRef<ImDrawList>(&NativePtr->DrawListInst);
	public ImGuiWindowPtr ParentWindow => new(NativePtr->ParentWindow);
	public ImGuiWindowPtr RootWindow => new(NativePtr->RootWindow);
	public ImGuiWindowPtr RootWindowDockTree => new(NativePtr->RootWindowDockTree);
	public ImGuiWindowPtr RootWindowForTitleBarHighlight => new(NativePtr->RootWindowForTitleBarHighlight);
	public ImGuiWindowPtr RootWindowForNav => new(NativePtr->RootWindowForNav);
	public ImGuiWindowPtr NavLastChildNavWindow => new(NativePtr->NavLastChildNavWindow);
	public RangeAccessor<uint> NavLastIds => new(NativePtr->NavLastIds, 2);
	public RangeAccessor<ImRect> NavRectRel => new(&NativePtr->NavRectRel_0, 2);
	...
	public ImGuiDockNodePtr DockNode => new(NativePtr->DockNode);
	public ImGuiDockNodePtr DockNodeAsHost => new(NativePtr->DockNodeAsHost);
	...
	public float CalcFontSize() {
		var ret = ImGuiNative.ImGuiWindow_CalcFontSize((ImGuiWindow*)(NativePtr));
		return ret;
	}
	public void Destroy() => ImGuiNative.ImGuiWindow_destroy((ImGuiWindow*)(NativePtr));
	public uint GetID(string str) {
		...
		var ret = ImGuiNative.ImGuiWindow_GetID_Str((ImGuiWindow*)(NativePtr), native_str, native_str_end);
		if(str_byteCount > Util.StackAllocationSizeLimit) {
	...
	public uint GetID(IntPtr ptr) {
		...
		var ret = ImGuiNative.ImGuiWindow_GetID_Ptr((ImGuiWindow*)(NativePtr), native_ptr);
		return ret;
	}
	public uint GetID(int n) {
		var ret = ImGuiNative.ImGuiWindow_GetID_Int((ImGuiWindow*)(NativePtr), n);
		return ret;
	}
	public uint GetIDFromRectangle(ImRect r_abs) {
		var ret = ImGuiNative.ImGuiWindow_GetIDFromRectangle((ImGuiWindow*)(NativePtr), r_abs);
		return ret;
	}
	public uint GetIDNoKeepAlive(string str) {
		...
		byte* native_str_end = null;
		var ret = ImGuiNative.ImGuiWindow_GetIDNoKeepAlive_Str((ImGuiWindow*)(NativePtr), native_str, native_str_end);
		if(str_byteCount > Util.StackAllocationSizeLimit) {
			Util.Free(native_str);
		}
		return ret;
	...
	public uint GetIDNoKeepAlive(IntPtr ptr) {
		var native_ptr = (void*)ptr.ToPointer();
		var ret = ImGuiNative.ImGuiWindow_GetIDNoKeepAlive_Ptr((ImGuiWindow*)(NativePtr), native_ptr);
		return ret;
	}
	public uint GetIDNoKeepAlive(int n) {
		var ret = ImGuiNative.ImGuiWindow_GetIDNoKeepAlive_Int((ImGuiWindow*)(NativePtr), n);
		return ret;
	}
	public float MenuBarHeight() {
		var ret = ImGuiNative.ImGuiWindow_MenuBarHeight((ImGuiWindow*)(NativePtr));
		return ret;
	}
	...
	public float TitleBarHeight() {
		var ret = ImGuiNative.ImGuiWindow_TitleBarHeight((ImGuiWindow*)(NativePtr));
		return ret;
	}
