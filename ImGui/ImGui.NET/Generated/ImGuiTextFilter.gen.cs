...
public unsafe partial struct ImGuiTextFilterPtr {
	...
	public ImPtrVector<ImGuiTextRangePtr> Filters => new(NativePtr->Filters, Unsafe.SizeOf<ImGuiTextRange>());
	public ref int CountGrep => ref Unsafe.AsRef<int>(&NativePtr->CountGrep);
	public void Build() => ImGuiNative.ImGuiTextFilter_Build((ImGuiTextFilter*)(NativePtr));
	public void Clear() => ImGuiNative.ImGuiTextFilter_Clear((ImGuiTextFilter*)(NativePtr));
	public void Destroy() => ImGuiNative.ImGuiTextFilter_destroy((ImGuiTextFilter*)(NativePtr));
	public bool Draw() {
		byte* native_label;
