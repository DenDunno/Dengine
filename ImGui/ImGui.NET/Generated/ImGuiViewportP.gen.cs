...
public unsafe partial struct ImGuiViewportPPtr {
	...
	public ImGuiWindowPtr Window => new(NativePtr->Window);
	public RangeAccessor<int> DrawListsLastFrame => new(NativePtr->DrawListsLastFrame, 2);
	public RangeAccessor<ImDrawList> DrawLists => new(&NativePtr->DrawLists_0, 2);
	...
	public void ClearRequestFlags() => ImGuiNative.ImGuiViewportP_ClearRequestFlags((ImGuiViewportP*)(NativePtr));
	public void Destroy() => ImGuiNative.ImGuiViewportP_destroy((ImGuiViewportP*)(NativePtr));
	...
	public void UpdateWorkRect() => ImGuiNative.ImGuiViewportP_UpdateWorkRect((ImGuiViewportP*)(NativePtr));
}
