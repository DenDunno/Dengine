...
public unsafe partial struct ImGuiOldColumnsPtr {
	...
	public ImPtrVector<ImGuiOldColumnDataPtr> Columns => new(NativePtr->Columns, Unsafe.SizeOf<ImGuiOldColumnData>());
	public ref ImDrawListSplitter Splitter => ref Unsafe.AsRef<ImDrawListSplitter>(&NativePtr->Splitter);
	public void Destroy() => ImGuiNative.ImGuiOldColumns_destroy((ImGuiOldColumns*)(NativePtr));
}
