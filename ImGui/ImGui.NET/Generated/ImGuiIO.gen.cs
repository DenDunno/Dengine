...
public unsafe partial struct ImGuiIOPtr {
	...
	public NullTerminatedString IniFilename => new(NativePtr->IniFilename);
	public NullTerminatedString LogFilename => new(NativePtr->LogFilename);
	...
	public RangeAccessor<int> KeyMap => new(NativePtr->KeyMap, 22);
	...
	public ImFontAtlasPtr Fonts => new(NativePtr->Fonts);
	...
	public ImFontPtr FontDefault => new(NativePtr->FontDefault);
	...
	public NullTerminatedString BackendPlatformName => new(NativePtr->BackendPlatformName);
	public NullTerminatedString BackendRendererName => new(NativePtr->BackendRendererName);
	...
	public RangeAccessor<bool> MouseDown => new(NativePtr->MouseDown, 5);
	...
	public RangeAccessor<bool> KeysDown => new(NativePtr->KeysDown, 512);
	public RangeAccessor<float> NavInputs => new(NativePtr->NavInputs, 21);
	...
	public RangeAccessor<Vector2> MouseClickedPos => new(&NativePtr->MouseClickedPos_0, 5);
	public RangeAccessor<double> MouseClickedTime => new(NativePtr->MouseClickedTime, 5);
	public RangeAccessor<bool> MouseClicked => new(NativePtr->MouseClicked, 5);
	public RangeAccessor<bool> MouseDoubleClicked => new(NativePtr->MouseDoubleClicked, 5);
	public RangeAccessor<bool> MouseReleased => new(NativePtr->MouseReleased, 5);
	public RangeAccessor<bool> MouseDownOwned => new(NativePtr->MouseDownOwned, 5);
	public RangeAccessor<bool> MouseDownWasDoubleClick => new(NativePtr->MouseDownWasDoubleClick, 5);
	...
	public RangeAccessor<Vector2> MouseDragMaxDistanceAbs => new(&NativePtr->MouseDragMaxDistanceAbs_0, 5);
	public RangeAccessor<float> MouseDragMaxDistanceSqr => new(NativePtr->MouseDragMaxDistanceSqr, 5);
	public RangeAccessor<float> KeysDownDuration => new(NativePtr->KeysDownDuration, 512);
	public RangeAccessor<float> KeysDownDurationPrev => new(NativePtr->KeysDownDurationPrev, 512);
	public RangeAccessor<float> NavInputsDownDuration => new(NativePtr->NavInputsDownDuration, 21);
	public RangeAccessor<float> NavInputsDownDurationPrev => new(NativePtr->NavInputsDownDurationPrev, 21);
	...
	public ImVector<ushort> InputQueueCharacters => new(NativePtr->InputQueueCharacters);
	public void AddInputCharacter(uint c) => ImGuiNative.ImGuiIO_AddInputCharacter((ImGuiIO*)(NativePtr), c);
	...
	public void AddInputCharacterUTF16(ushort c) => ImGuiNative.ImGuiIO_AddInputCharacterUTF16((ImGuiIO*)(NativePtr), c);
	public void ClearInputCharacters() => ImGuiNative.ImGuiIO_ClearInputCharacters((ImGuiIO*)(NativePtr));
	public void Destroy() => ImGuiNative.ImGuiIO_destroy((ImGuiIO*)(NativePtr));
}
