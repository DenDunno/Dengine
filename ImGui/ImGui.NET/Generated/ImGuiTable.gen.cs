...
public unsafe partial struct ImGuiTablePtr {
	...
	public ImGuiTableTempDataPtr TempData => new(NativePtr->TempData);
	public ImPtrSpan<ImGuiTableColumnPtr> Columns => new(NativePtr->Columns, Unsafe.SizeOf<ImGuiTableColumn>());
	public ImSpan<sbyte> DisplayOrderToIndex => new(NativePtr->DisplayOrderToIndex);
	public ImPtrSpan<ImGuiTableCellDataPtr> RowCellData => new(NativePtr->RowCellData, Unsafe.SizeOf<ImGuiTableCellData>());
	...
	public RangeAccessor<uint> RowBgColor => new(NativePtr->RowBgColor, 2);
	...
	public ImGuiWindowPtr OuterWindow => new(NativePtr->OuterWindow);
	public ImGuiWindowPtr InnerWindow => new(NativePtr->InnerWindow);
	public ref ImGuiTextBuffer ColumnsNames => ref Unsafe.AsRef<ImGuiTextBuffer>(&NativePtr->ColumnsNames);
	public ImDrawListSplitterPtr DrawSplitter => new(NativePtr->DrawSplitter);
	...
	public ImPtrVector<ImGuiTableColumnSortSpecsPtr> SortSpecsMulti => new(NativePtr->SortSpecsMulti, Unsafe.SizeOf<ImGuiTableColumnSortSpecs>());
	...
	public void Destroy() => ImGuiNative.ImGuiTable_destroy((ImGuiTable*)(NativePtr));
}
