...
public unsafe partial struct ImDrawListSharedDataPtr {
	...
	public ImFontPtr Font => new(NativePtr->Font);
	...
	public RangeAccessor<Vector2> ArcFastVtx => new(&NativePtr->ArcFastVtx_0, 48);
	public ref float ArcFastRadiusCutoff => ref Unsafe.AsRef<float>(&NativePtr->ArcFastRadiusCutoff);
	public RangeAccessor<byte> CircleSegmentCounts => new(NativePtr->CircleSegmentCounts, 64);
	public IntPtr TexUvLines { get => (IntPtr)NativePtr->TexUvLines; set => NativePtr->TexUvLines = (Vector4*)value; }
	public void Destroy() => ImGuiNative.ImDrawListSharedData_destroy((IntPtr)(NativePtr));
	public void SetCircleTessellationMaxError(float max_error) => ImGuiNative.ImDrawListSharedData_SetCircleTessellationMaxError((IntPtr)(NativePtr), max_error);
}
