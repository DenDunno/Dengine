...
public unsafe partial struct ImGuiContextPtr {
	...
	public ImVector<ImGuiWindowPtr> WindowsFocusOrder => new(NativePtr->WindowsFocusOrder);
	public ImVector<ImGuiWindowPtr> WindowsTempSortBuffer => new(NativePtr->WindowsTempSortBuffer);
	public ImVector<ImGuiWindowPtr> CurrentWindowStack => new(NativePtr->CurrentWindowStack);
	...
	public ImGuiWindowPtr CurrentWindow => new(NativePtr->CurrentWindow);
	public ImGuiWindowPtr HoveredWindow => new(NativePtr->HoveredWindow);
	public ImGuiWindowPtr HoveredWindowUnderMovingWindow => new(NativePtr->HoveredWindowUnderMovingWindow);
	public ImGuiDockNodePtr HoveredDockNode => new(NativePtr->HoveredDockNode);
	public ImGuiWindowPtr MovingWindow => new(NativePtr->MovingWindow);
	public ImGuiWindowPtr WheelingWindow => new(NativePtr->WheelingWindow);
	...
	public ImGuiWindowPtr ActiveIdWindow => new(NativePtr->ActiveIdWindow);
	...
	public ImGuiWindowPtr ActiveIdPreviousFrameWindow => new(NativePtr->ActiveIdPreviousFrameWindow);
	...
	public ImPtrVector<ImGuiColorModPtr> ColorStack => new(NativePtr->ColorStack, Unsafe.SizeOf<ImGuiColorMod>());
	public ImPtrVector<ImGuiStyleModPtr> StyleVarStack => new(NativePtr->StyleVarStack, Unsafe.SizeOf<ImGuiStyleMod>());
	public ImVector<ImFontPtr> FontStack => new(NativePtr->FontStack);
	public ImVector<uint> FocusScopeStack => new(NativePtr->FocusScopeStack);
	public ImPtrVector<ImGuiGroupDataPtr> GroupStack => new(NativePtr->GroupStack, Unsafe.SizeOf<ImGuiGroupData>());
	public ImPtrVector<ImGuiPopupDataPtr> OpenPopupStack => new(NativePtr->OpenPopupStack, Unsafe.SizeOf<ImGuiPopupData>());
	public ImPtrVector<ImGuiPopupDataPtr> BeginPopupStack => new(NativePtr->BeginPopupStack, Unsafe.SizeOf<ImGuiPopupData>());
	public ImVector<ImGuiViewportPPtr> Viewports => new(NativePtr->Viewports);
	public ref float CurrentDpiScale => ref Unsafe.AsRef<float>(&NativePtr->CurrentDpiScale);
	public ImGuiViewportPPtr CurrentViewport => new(NativePtr->CurrentViewport);
	public ImGuiViewportPPtr MouseViewport => new(NativePtr->MouseViewport);
	public ImGuiViewportPPtr MouseLastHoveredViewport => new(NativePtr->MouseLastHoveredViewport);
	...
	public ImGuiWindowPtr NavWindow => new(NativePtr->NavWindow);
	...
	public ref ImGuiNavItemData NavMoveResultLocalVisibleSet => ref Unsafe.AsRef<ImGuiNavItemData>(&NativePtr->NavMoveResultLocalVisibleSet);
	public ref ImGuiNavItemData NavMoveResultOther => ref Unsafe.AsRef<ImGuiNavItemData>(&NativePtr->NavMoveResultOther);
	public ImGuiWindowPtr NavWrapRequestWindow => new(NativePtr->NavWrapRequestWindow);
	public ref ImGuiNavMoveFlags NavWrapRequestFlags => ref Unsafe.AsRef<ImGuiNavMoveFlags>(&NativePtr->NavWrapRequestFlags);
	public ImGuiWindowPtr NavWindowingTarget => new(NativePtr->NavWindowingTarget);
	public ImGuiWindowPtr NavWindowingTargetAnim => new(NativePtr->NavWindowingTargetAnim);
	public ImGuiWindowPtr NavWindowingListWindow => new(NativePtr->NavWindowingListWindow);
	...
	public ImGuiWindowPtr TabFocusRequestCurrWindow => new(NativePtr->TabFocusRequestCurrWindow);
	public ImGuiWindowPtr TabFocusRequestNextWindow => new(NativePtr->TabFocusRequestNextWindow);
	...
	public ImVector<byte> DragDropPayloadBufHeap => new(NativePtr->DragDropPayloadBufHeap);
	public RangeAccessor<byte> DragDropPayloadBufLocal => new(NativePtr->DragDropPayloadBufLocal, 16);
	public ImGuiTablePtr CurrentTable => new(NativePtr->CurrentTable);
	public ref int CurrentTableStackIdx => ref Unsafe.AsRef<int>(&NativePtr->CurrentTableStackIdx);
	public ImPtrVector<ImDrawChannelPtr> DrawChannelsTempMergeBuffer => new(NativePtr->DrawChannelsTempMergeBuffer, Unsafe.SizeOf<ImDrawChannel>());
	public ImGuiTabBarPtr CurrentTabBar => new(NativePtr->CurrentTabBar);
	public ImPtrVector<ImGuiPtrOrIndexPtr> CurrentTabBarStack => new(NativePtr->CurrentTabBarStack, Unsafe.SizeOf<ImGuiPtrOrIndex>());
	public ImPtrVector<ImGuiShrinkWidthItemPtr> ShrinkWidthBuffer => new(NativePtr->ShrinkWidthBuffer, Unsafe.SizeOf<ImGuiShrinkWidthItem>());
	...
	public RangeAccessor<float> ColorEditLastColor => new(NativePtr->ColorEditLastColor, 3);
	...
	public ImVector<byte> ClipboardHandlerData => new(NativePtr->ClipboardHandlerData);
	public ImVector<uint> MenusIdSubmittedThisFrame => new(NativePtr->MenusIdSubmittedThisFrame);
	...
	public ImGuiViewportPPtr PlatformImePosViewport => new(NativePtr->PlatformImePosViewport);
	...
	public ImPtrVector<ImGuiSettingsHandlerPtr> SettingsHandlers => new(NativePtr->SettingsHandlers, Unsafe.SizeOf<ImGuiSettingsHandler>());
	public ImPtrVector<ImGuiContextHookPtr> Hooks => new(NativePtr->Hooks, Unsafe.SizeOf<ImGuiContextHook>());
	...
	public void Destroy() => ImGuiNative.ImGuiContext_destroy((IntPtr)(NativePtr));
}
