...
public unsafe partial struct ImFontPtr {
	...
	public RangeAccessor<byte> Used4kPagesMap => new(NativePtr->Used4kPagesMap, 34);
	...
	public void BuildLookupTable() => ImGuiNative.ImFont_BuildLookupTable((ImFont*)(NativePtr));
	public void ClearOutputData() => ImGuiNative.ImFont_ClearOutputData((ImFont*)(NativePtr));
	public void Destroy() => ImGuiNative.ImFont_destroy((ImFont*)(NativePtr));
	...
	public void GrowIndex(int new_size) => ImGuiNative.ImFont_GrowIndex((ImFont*)(NativePtr), new_size);
