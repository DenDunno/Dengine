...
public unsafe partial struct ImRectPtr {
	...
	public void Add(Vector2 p) => ImGuiNative.ImRect_Add_Vec2((ImRect*)(NativePtr), p);
	public void Add(ImRect r) => ImGuiNative.ImRect_Add_Rect((ImRect*)(NativePtr), r);
	...
	public bool Contains(Vector2 p) {
		var ret = ImGuiNative.ImRect_Contains_Vec2((ImRect*)(NativePtr), p);
		return ret != 0;
	}
	public bool Contains(ImRect r) {
		var ret = ImGuiNative.ImRect_Contains_Rect((ImRect*)(NativePtr), r);
		return ret != 0;
	}
	public void Destroy() => ImGuiNative.ImRect_destroy((ImRect*)(NativePtr));
	public void Expand(float amount) => ImGuiNative.ImRect_Expand_Float((ImRect*)(NativePtr), amount);
	public void Expand(Vector2 amount) => ImGuiNative.ImRect_Expand_Vec2((ImRect*)(NativePtr), amount);
	public void Floor() => ImGuiNative.ImRect_Floor((ImRect*)(NativePtr));
	public float GetArea() {
		var ret = ImGuiNative.ImRect_GetArea((ImRect*)(NativePtr));
		return ret;
	}
	...
	public float GetHeight() {
		var ret = ImGuiNative.ImRect_GetHeight((ImRect*)(NativePtr));
		return ret;
	}
	...
	public float GetWidth() {
		var ret = ImGuiNative.ImRect_GetWidth((ImRect*)(NativePtr));
		return ret;
	}
	public bool IsInverted() {
		var ret = ImGuiNative.ImRect_IsInverted((ImRect*)(NativePtr));
		return ret != 0;
	}
	public bool Overlaps(ImRect r) {
		var ret = ImGuiNative.ImRect_Overlaps((ImRect*)(NativePtr), r);
		return ret != 0;
	}
	...
	public void Translate(Vector2 d) => ImGuiNative.ImRect_Translate((ImRect*)(NativePtr), d);
	public void TranslateX(float dx) => ImGuiNative.ImRect_TranslateX((ImRect*)(NativePtr), dx);
	public void TranslateY(float dy) => ImGuiNative.ImRect_TranslateY((ImRect*)(NativePtr), dy);
}
