...
public unsafe partial struct ImDrawListSplitterPtr {
	...
	public ImPtrVector<ImDrawChannelPtr> _Channels => new(NativePtr->_Channels, Unsafe.SizeOf<ImDrawChannel>());
	public void Clear() => ImGuiNative.ImDrawListSplitter_Clear((ImDrawListSplitter*)(NativePtr));
	public void ClearFreeMemory() => ImGuiNative.ImDrawListSplitter_ClearFreeMemory((ImDrawListSplitter*)(NativePtr));
	public void Destroy() => ImGuiNative.ImDrawListSplitter_destroy((ImDrawListSplitter*)(NativePtr));
