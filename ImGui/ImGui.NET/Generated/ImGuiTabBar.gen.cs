...
public unsafe partial struct ImGuiTabBarPtr {
	...
	public ImPtrVector<ImGuiTabItemPtr> Tabs => new(NativePtr->Tabs, Unsafe.SizeOf<ImGuiTabItem>());
	...
	public void Destroy() => ImGuiNative.ImGuiTabBar_destroy((ImGuiTabBar*)(NativePtr));
	public string GetTabName(ImGuiTabItemPtr tab) {
		var native_tab = tab.NativePtr;
		var ret = ImGuiNative.ImGuiTabBar_GetTabName((ImGuiTabBar*)(NativePtr), native_tab);
		return Util.StringFromPtr(ret);
	}
	public int GetTabOrder(ImGuiTabItemPtr tab) {
		var native_tab = tab.NativePtr;
		var ret = ImGuiNative.ImGuiTabBar_GetTabOrder((ImGuiTabBar*)(NativePtr), native_tab);
		return ret;
	}
}
