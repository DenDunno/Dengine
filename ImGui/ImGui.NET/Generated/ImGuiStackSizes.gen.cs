...
public unsafe partial struct ImGuiStackSizesPtr {
	...
	public void CompareWithCurrentState() => ImGuiNative.ImGuiStackSizes_CompareWithCurrentState((ImGuiStackSizes*)(NativePtr));
	public void Destroy() => ImGuiNative.ImGuiStackSizes_destroy((ImGuiStackSizes*)(NativePtr));
	public void SetToCurrentState() => ImGuiNative.ImGuiStackSizes_SetToCurrentState((ImGuiStackSizes*)(NativePtr));
}
