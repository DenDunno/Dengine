...
public unsafe partial struct ImGuiWindowTempDataPtr {
	...
	public ImVector<ImGuiWindowPtr> ChildWindows => new(NativePtr->ChildWindows);
	public ImGuiStoragePtr StateStorage => new(NativePtr->StateStorage);
	public ImGuiOldColumnsPtr CurrentColumns => new(NativePtr->CurrentColumns);
	...
	public ImVector<float> ItemWidthStack => new(NativePtr->ItemWidthStack);
	public ImVector<float> TextWrapPosStack => new(NativePtr->TextWrapPosStack);
