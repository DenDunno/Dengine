...
public unsafe partial struct ImGuiPlatformIOPtr {
	...
	public static implicit operator ImGuiPlatformIOPtr(ImGuiPlatformIO* nativePtr) => new(nativePtr);
	public static implicit operator ImGuiPlatformIO*(ImGuiPlatformIOPtr wrappedPtr) => wrappedPtr.NativePtr;
	public static implicit operator ImGuiPlatformIOPtr(IntPtr nativePtr) => new(nativePtr);
	...
	public ImPtrVector<ImGuiPlatformMonitorPtr> Monitors => new(NativePtr->Monitors, Unsafe.SizeOf<ImGuiPlatformMonitor>());
	public ImVector<ImGuiViewportPtr> Viewports => new(NativePtr->Viewports);
	public void Destroy() => ImGuiNative.ImGuiPlatformIO_destroy((ImGuiPlatformIO*)(NativePtr));
}
