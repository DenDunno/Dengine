...
public unsafe partial struct ImGuiDockNodePtr {
	...
	public static implicit operator ImGuiDockNodePtr(ImGuiDockNode* nativePtr) => new(nativePtr);
	public static implicit operator ImGuiDockNode*(ImGuiDockNodePtr wrappedPtr) => wrappedPtr.NativePtr;
	public static implicit operator ImGuiDockNodePtr(IntPtr nativePtr) => new(nativePtr);
	...
	public ImGuiDockNodePtr ParentNode => new(NativePtr->ParentNode);
	public RangeAccessor<ImGuiDockNode> ChildNodes => new(&NativePtr->ChildNodes_0, 2);
	public ImVector<ImGuiWindowPtr> Windows => new(NativePtr->Windows);
	public ImGuiTabBarPtr TabBar => new(NativePtr->TabBar);
	...
	public ImGuiWindowPtr HostWindow => new(NativePtr->HostWindow);
	public ImGuiWindowPtr VisibleWindow => new(NativePtr->VisibleWindow);
	public ImGuiDockNodePtr CentralNode => new(NativePtr->CentralNode);
	public ImGuiDockNodePtr OnlyNodeWithWindows => new(NativePtr->OnlyNodeWithWindows);
	...
	public void Destroy() => ImGuiNative.ImGuiDockNode_destroy((ImGuiDockNode*)(NativePtr));
	public bool IsCentralNode() {
		var ret = ImGuiNative.ImGuiDockNode_IsCentralNode((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsDockSpace() {
		var ret = ImGuiNative.ImGuiDockNode_IsDockSpace((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsEmpty() {
		var ret = ImGuiNative.ImGuiDockNode_IsEmpty((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsFloatingNode() {
		var ret = ImGuiNative.ImGuiDockNode_IsFloatingNode((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsHiddenTabBar() {
		var ret = ImGuiNative.ImGuiDockNode_IsHiddenTabBar((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsLeafNode() {
		var ret = ImGuiNative.ImGuiDockNode_IsLeafNode((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsNoTabBar() {
		var ret = ImGuiNative.ImGuiDockNode_IsNoTabBar((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsRootNode() {
		var ret = ImGuiNative.ImGuiDockNode_IsRootNode((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public bool IsSplitNode() {
		var ret = ImGuiNative.ImGuiDockNode_IsSplitNode((ImGuiDockNode*)(NativePtr));
		return ret != 0;
	}
	public ImRect Rect() {
		ImRect __retval;
	...
	public void SetLocalFlags(ImGuiDockNodeFlags flags) => ImGuiNative.ImGuiDockNode_SetLocalFlags((ImGuiDockNode*)(NativePtr), flags);
	public void UpdateMergedFlags() => ImGuiNative.ImGuiDockNode_UpdateMergedFlags((ImGuiDockNode*)(NativePtr));
}
