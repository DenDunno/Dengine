...
public static unsafe partial class ImGuizmoNative {
	...
	[DllImport("cimguizmo", CallingConvention = CallingConvention.Cdecl)]
	public static extern byte ImGuizmo_IsOver_OPERATION(TransformOperation op);
	[DllImport("cimguizmo", CallingConvention = CallingConvention.Cdecl)]
	public static extern byte ImGuizmo_IsUsing();
	[DllImport("cimguizmo", CallingConvention = CallingConvention.Cdecl)]
	public static extern byte ImGuizmo_Manipulate(float* view, float* projection, TransformOperation operation, TransformMode mode, float* matrix, float* deltaMatrix, float* snap, float* localBounds, float* boundsSnap);
	[DllImport("cimguizmo", CallingConvention = CallingConvention.Cdecl)]
